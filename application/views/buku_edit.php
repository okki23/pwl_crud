...
<html lang="en" class="h-100" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>Perpustakaan Online - Buku</title>
...
<div class="container">
<form action="<?php echo base_url('buku/saveubah'); ?>" method="POST" enctype="multipart/form-data">
<input type="hidden" value="<?php echo $fetch->id; ?>" name="id">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Nama Buku</label>
    <input type="text" class="form-control" id="nama_buku" name="nama_buku" value="<?php echo $fetch->nama_buku; ?>"  > 
  </div>
  <div class="mb-3">
...
<footer class="footer mt-auto py-3 bg-body-tert @2023 =  Pemrograman Web Lanjutiary">
  <div class="container">
    <span class="text-body-secondary"> Perpustakaan Online &copy; 2023 | Pemrograman Web Lanjut</span>
  </div>
</footer>
